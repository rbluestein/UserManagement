...
#End Region
    ...
    Private Function DeleteLicense() As Results
    ...
    Private Function DefineDataGrid(ByVal Entity As String) As DG
        ...
        Try
            ...
            If Entity = "state" Then
                ...
                Menu.AddItem(DG.Menu.ObjectTypeEnum.IsLink, "NewLicense", "New", RightsClass.LicenseEdit)
                ...
                TemplateCol.AddDefaultTemplateItem("View", "ExistingLicense", "StandardView", "License Detail", RightsClass.LicenseView, Nothing, "LicenseNumber", "EffectiveDate")
                TemplateCol.AddDefaultTemplateItem("Appointment", "NewAppointment", "StandardClip", "New Appointment", RightsClass.LicenseEdit, Nothing)
                TemplateCol.AddDefaultTemplateItem("DeleteLic", "DeleteLic", "StandardDelete", "Delete", RightsClass.LicenseEdit, Nothing, "LicenseNumber", "EffectiveDate")
            ...
            ElseIf Entity = "appointments" Then
                ...
                Dim TemplateCol As New DG.TemplateColumn("Icons", Nothing, False, Nothing, True)
                TemplateCol.AddDefaultTemplateItem("View", "ExistingAppointment", "StandardView", "Appointment Detail", RightsClass.LicenseView, Nothing, "CarrierID", "EffectiveDate", "AppointmentNumber")
                TemplateCol.AddDefaultTemplateItem("DeleteAppt", "DeleteAppt", "StandardDelete", "Delete", RightsClass.LicenseEdit, Nothing, "CarrierID", "EffectiveDate", "AppointmentNumber")
                DG.AttachTemplateCol(TemplateCol)
