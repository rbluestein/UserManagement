Public Class Enviro
#Region " Constants "
    Private cVersionNumberColl As CollX
...
#End Region
    ...
    Public Sub New()
        cVersionNumberColl = New CollX
        cVersionNumberColl.Assign("1.37", "")
        cVersionNumberColl.Assign("1.38", "Added encryption of connectionstring")
        cVersionNumberColl.Assign("2.00.00", "Converted to VS2008")
    End Sub
...
#Region " Properties "
    ...
    Public ReadOnly Property VersionNumber() As String
        Get
            'Return cVersionNumberColl(cVersionNumberColl.Count)
            Return cVersionNumberColl.Key(cVersionNumberColl.Count)
        End Get
    End Property
