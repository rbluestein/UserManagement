...
#Region " Page handling "
    ...
    Public Function GetRequestAction(ByVal Page As Page) As RequestActionEnum
        ...
        Select Case ActionType
            Case "return"
                RequestAction = RequestActionEnum.ReturnToParent
            ...
            Case "record"
                ...
                Else
                    Select Case Page.Request.Form("hdResponseAction")
                        Case ResponseActionEnum.DisplayBlank.ToString
                            RequestAction = RequestActionEnum.SaveNew
                        Case ResponseActionEnum.DisplayExisting.ToString
                            RequestAction = RequestActionEnum.SaveExisting
                        Case ResponseActionEnum.DisplayUserInputNew.ToString
                            RequestAction = RequestActionEnum.SaveNew
                        Case ResponseActionEnum.DisplayUserInputExisting.ToString
                            RequestAction = RequestActionEnum.SaveExisting
                        Case ResponseActionEnum.DisplayUserInputNewOrExisting.ToString
                            RequestAction = RequestActionEnum.SaveNewOrExisting
                    End Select
                End If
    ...
    Public Function GetResponseActionFromRequestActionOther(ByRef Page As Page) As ResponseActionEnum
        Select Case Page.Request("hdResponseAction").ToString
            Case ResponseActionEnum.DisplayBlank.ToString
                Return ResponseActionEnum.DisplayUserInputNew
            Case ResponseActionEnum.DisplayExisting.ToString
                Return ResponseActionEnum.DisplayUserInputExisting
            Case ResponseActionEnum.DisplayUserInputExisting.ToString
                Return ResponseActionEnum.DisplayUserInputExisting
            Case ResponseActionEnum.DisplayUserInputNew.ToString
                Return ResponseActionEnum.DisplayUserInputNew
            Case ResponseActionEnum.ReturnToCallingPage.ToString
                Return ResponseActionEnum.ReturnToCallingPage
        End Select
    End Function
#End Region
...
#Region " Everything else "
    ...
    Public Sub FormatCalendar(ByRef Calendar1 As System.Web.UI.WebControls.Calendar)
        With Calendar1
            .Font.Name = "Verdana;Arial"
            .NextPrevFormat = NextPrevFormat.ShortMonth
            .Font.Size = System.Web.UI.WebControls.FontUnit.Point(8)
            .DayHeaderStyle.BackColor = Drawing.Color.LightSkyBlue
            .DayStyle.BackColor = Drawing.Color.White
            .OtherMonthDayStyle.ForeColor = Drawing.Color.Gray
            .OtherMonthDayStyle.BackColor = Drawing.Color.White
            .TitleStyle.BackColor = Drawing.Color.LightSkyBlue
            .TitleStyle.ForeColor = Drawing.Color.Black
            .TitleStyle.Font.Bold = True
            .SelectedDayStyle.BackColor = Drawing.Color.Navy
