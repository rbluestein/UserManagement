...
Public Class DBase
    ...
    Public ReadOnly Property DictColl() As Collection
        Get
            Return cDictColl
        End Get
    End Property
    ...
    Public Class SqlDataElement
                ...
                Select Case cDictItem.DataGroup
                    ...
                    Case DBase.SqlDataGroupEnum.SqlGroupDateTime
                        If IsDBNull(cValue) Then
                            Result = String.Empty
                        Else
                            Result = CType(cValue, System.DateTime)
                        End If
                    ...
                    Case DBase.SqlDataGroupEnum.SqlGroupFloat
                        If IsDBNull(cValue) Then
                            Result = 0
                        Else
                            Result = CType(cValue, System.Double)
                        End If
                    ...
                    Case DBase.SqlDataGroupEnum.SqlGroupInt
                        If IsDBNull(cValue) Then
                            Result = 0
                        Else
                            Result = CType(cValue, System.Int64)
                        End If

                    Case DBase.SqlDataGroupEnum.SqlGroupMoney
                        If IsDBNull(cValue) Then
                            Result = FormatNumber(CType(0, System.Decimal), 2)
                        Else
                            Result = FormatNumber(CType(cValue, System.Decimal), 2)
                        End If
                    ...
                    Case DBase.SqlDataGroupEnum.SqlGroupVarchar
                        If IsDBNull(cValue) Then
                            Result = String.Empty
                        Else
                            Result = CType(cValue, System.String)
                        End If
                End Select
                Return Result
            End Get
        ...
        Private Function GetToSqlRaw() As String
                    ...
                    If IsDBNull(cValue) Then
                        ...
                        Else
                            ...
                            Else
                                ...
                                Result = CType(cDictItem.DefaultValue, System.String)
                            End If
                        End If
                    Else
                        If cValue = 0 Then
