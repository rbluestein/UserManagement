...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            RightsRqd.SetValue(RightsClass.ClientView, 0)
        ...
        Catch ex As Exception
            Dim ErrorObj As New ErrorObj(ex, "Error #1402: ClientWorklist Page_Load. " & ex.Message)
        End Try
    End Sub
    ...
    Private Function DefineDataGrid() As DG
        Try
            ...
            DG.AddNewButton(RightsClass.ClientEdit)
            ...
            TemplateCol.AddDefaultTemplateItem("View", "ExistingRecord", "StandardView", "View", RightsClass.ClientView, Nothing)
            TemplateCol.AddDefaultTemplateItem("Delete", "Delete", "StandardDelete", "Delete", RightsClass.ClientView, Nothing)
