<%@ Page Language="vb" AutoEventWireup="false" Codebehind="QueryCarrier.aspx.vb" Inherits="UserManagement.QueryCarrier" %>
...
<html>
	...
	<body>
		<form id="form1" name="form1" action="QueryCarrier.aspx" method="post" runat="server">
