...
#Region " Declarations "
    ...
    Protected WithEvents txtPrimaryContactNumber As System.Web.UI.WebControls.TextBox
    Protected WithEvents txtAltContactNumber As System.Web.UI.WebControls.TextBox
    Protected WithEvents ddResidentState As System.Web.UI.WebControls.DropDownList
    Protected WithEvents ddCompanyID As System.Web.UI.WebControls.DropDownList
    Protected WithEvents ddLocationID As System.Web.UI.WebControls.DropDownList
    Protected WithEvents ddRole As System.Web.UI.WebControls.DropDownList
    Protected WithEvents ddWorkState As System.Web.UI.WebControls.DropDownList
    ...
    Protected WithEvents txtResidentState As System.Web.UI.WebControls.TextBox
    ...
    Protected WithEvents ddStatusCode As System.Web.UI.WebControls.DropDownList
    Protected WithEvents txtStatusCode As System.Web.UI.WebControls.TextBox
    Protected WithEvents txtNationalProducerNumber As System.Web.UI.WebControls.TextBox
    ...
    Protected WithEvents ddLongTermCareCertState As System.Web.UI.WebControls.DropDownList
    Protected WithEvents txtLongTermCareCertState As System.Web.UI.WebControls.TextBox
    Protected WithEvents txtLongTermCareCertEffectiveDate As System.Web.UI.WebControls.TextBox
    Protected WithEvents lblLongTermCareCertEffectiveDateLink As System.Web.UI.WebControls.Label
    Protected WithEvents txtLongTermCareCertExpirationDate As System.Web.UI.WebControls.TextBox
    Protected WithEvents lblLongTermCareCertExpirationDateLink As System.Web.UI.WebControls.Label
    Protected WithEvents txtPhoneExtension As System.Web.UI.WebControls.TextBox
    Protected WithEvents plEnrollerSection As System.Web.UI.WebControls.PlaceHolder
    Protected WithEvents plPersonalData As System.Web.UI.WebControls.PlaceHolder
    Protected WithEvents plEmploymentData As System.Web.UI.WebControls.PlaceHolder
    Protected WithEvents plBVIUser As System.Web.UI.WebControls.PlaceHolder
    Protected WithEvents plNonBVIUser As System.Web.UI.WebControls.PlaceHolder
    Protected WithEvents litFalcon As System.Web.UI.WebControls.Literal
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            RightsRqd.SetValue(cRights.UserView, 0)
    ...
    Private Function IsDataValid(ByVal RequestAction As RequestAction, ByRef TerminateAppointments As Boolean) As Results
        Dim i As Integer
        Dim MyResults As New Results
        ...
        Try
            ...
            ' ___ UserID
            If RequestAction = RequestAction.SaveExisting AndAlso txtUserID.Text.ToLower <> cSess.UserID.ToLower Then
                dt = cCommon.GetDT("Select Count (*) FROM Users WHERE lower(UserID) = '" & txtUserID.Text.ToLower & "'")
                If dt.Rows(0)(0) > 0 Then
                    cCommon.ValidateErrorOnly(ErrColl, "user id is already  in use")
                End If
            ...
            ' ___ StatusCode
            If RequestAction = RequestAction.SaveExisting Then
            ...
            HandleFalcon(ResponseAction.DisplayUserInputNewOrExisting)
    ...
    Private Function PerformSave(ByVal RequestAction As RequestAction, ByVal TerminateAppointments As Boolean) As Results
        Dim i As Integer
        ...
        Try
            ...
            Try
                ...
                If RequestAction <> RequestAction.SaveNew AndAlso OldUserID <> cSess.UserID Then
    ...
    Private Sub NotifyNetAdmin(ByVal RequestAction As RequestAction, ByVal OldStatusCode As String)
        Dim i As Integer
        ...
        Try
            ...
            Select Case ResponseAction
                ...
                Case ResponseAction.DisplayExisting
                    If cRights.HasThisRight(cRights.UserEdit) Then
    ...
    Private Sub HandleFalcon(ByVal ResponseAction As ResponseAction)
        Dim i As Integer
        ...
        Try
            ...
            Select Case ResponseAction
                ...
                Case ResponseAction.DisplayUserInputNew, ResponseAction.DisplayUserInputExisting, ResponseAction.DisplayUserInputNewOrExisting
            ...
            If ResponseAction <> ResponseAction.DisplayUserInputNewOrExisting Then
