...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Catch ex As Exception
            Throw New Exception("Error #550: Appointment Page_Load. " & ex.Message)
        End Try
    End Sub
    ...
    Private Function PerformSave(ByVal RequestAction As RequestAction) As Results
        ...
        Try
            ...
            If QueryPack.Success Then
                If RequestAction = (RequestAction.SaveNew AndAlso ddStatusCode.SelectedValue = "X") Or (RequestAction.SaveExisting AndAlso CurStatusCode <> "X" AndAlso ddStatusCode.SelectedValue = "X") Then
                    If JITAppt.IsJITTrigger(cSess.UserID, cSess.State, cSess.CarrierID) Then
                        ...
                        If cBulkAppointmentDataPack.DT.Rows.Count > 0 Then
                            cBulkAppointmentDataPack.BulkAdd(cBulkAppointmentDataPack.SaveTypeClass.JITTrigger, cSess.State, cSess.CarrierID, 1, Nothing, True)
                        End If
                    End If
                End If
            End If
        ...
        Try
            ...
            If ResponseAction = ResponseAction.DisplayExisting Then
                ...
                For i = 0 To ddStatusCode.Items.Count - 1
                    ...
                    End If
                Next
                Select Case dt.Rows(0)("StatusCode")
                    Case String.Empty
