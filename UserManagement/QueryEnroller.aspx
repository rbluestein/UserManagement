<%@ Page Language="vb" AutoEventWireup="false" Codebehind="QueryEnroller.aspx.vb" Inherits="UserManagement.QueryEnroller"%>
...
<html>
	...
	<body>
		<form id="form1" name="form1" action="QueryEnroller.aspx" method="post" runat="server">
			...
			<table class="PrimaryTbl" style="LEFT: 140px; POSITION: absolute; TOP: 14px" cellspacing="0"
				...
				<tr>
					<td colspan="2" class="PrimaryTblTitle">Enroller Query</td>
				</tr>
				<tr>
