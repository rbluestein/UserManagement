            ...
            For i = 0 To dtJITCarriers.Rows.Count - 1
                ...
                If IsTriggeringStateAJITStateForThisCarrier(TriggeringState, CarrierID) Then
                    ...
                    If Coll("HasAppointment") Then
                        ...
                        cBulkAppointmentDataPack.BulkAdd(cBulkAppointmentDataPack.SaveTypeClass.JITQualify, TriggeringState, CarrierID, 1, Nothing)
                    End If
                End If
            Next
        ...
        Try
            ...
            For i = 0 To dtStateJITBlock.Rows.Count - 1
                ...
                If JITArgs.Qualifies Then
                    ...
                    cBulkAppointmentDataPack.BulkAdd(cBulkAppointmentDataPack.SaveTypeClass.JITQualify, dtStateJITBlock.Rows(i)("State"), CarrierID, 1, Nothing)

                Else

                    If JITArgs.Comment = "Triggering state" Or JITArgs.Comment = "Previously added" Then
                    Else
                        cBulkAppointmentDataPack.BulkAdd(cBulkAppointmentDataPack.SaveTypeClass.JITQualify, dtStateJITBlock.Rows(i)("State"), CarrierID, 0, JITArgs.Comment)
                    End If
