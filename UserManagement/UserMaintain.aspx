<%@ Page Language="vb" AutoEventWireup="false" Codebehind="UserMaintain.aspx.vb" Inherits="UserManagement.UserMaintain" %>
...
<html>
	<head>
		...
		<link title="BVIStyle" rel="stylesheet" type="text/css" href="BVI.css">
	...
	<body>
		<form id="form1" method="post" name="form1" action="UserMaintain.aspx" runat="server">
