...
#Region " Declarations "
    ...
    Protected WithEvents Button1 As System.Web.UI.HtmlControls.HtmlTableCell
    Protected WithEvents Button2 As System.Web.UI.WebControls.Button
    Protected WithEvents ddEnrollersSource As System.Web.UI.WebControls.DropDownList
    Protected WithEvents btnEnrollerAdd As System.Web.UI.WebControls.Button
    Protected WithEvents btnEnrollerRemove As System.Web.UI.WebControls.Button
    Protected WithEvents txtEnrollerTarget As System.Web.UI.WebControls.TextBox
    Protected WithEvents lstCarriersSource As System.Web.UI.WebControls.ListBox
    Protected WithEvents btnCarrierAdd As System.Web.UI.WebControls.Button
    Protected WithEvents btnCarrierRemove As System.Web.UI.WebControls.Button
    Protected WithEvents lstCarriersTarget As System.Web.UI.WebControls.ListBox
    Protected WithEvents lstStatesSource As System.Web.UI.WebControls.ListBox
    Protected WithEvents btnStateAdd As System.Web.UI.WebControls.Button
    Protected WithEvents btnStateRemove As System.Web.UI.WebControls.Button
    Protected WithEvents lstStatesTarget As System.Web.UI.WebControls.ListBox
    Protected WithEvents txtStatus As System.Web.UI.WebControls.TextBox
    Protected WithEvents txtAppointmentNumber As System.Web.UI.WebControls.TextBox
    Protected WithEvents txtApplicationDate As System.Web.UI.WebControls.TextBox
    Protected WithEvents lblApplicationDateLink As System.Web.UI.WebControls.Label
    Protected WithEvents txtEffectiveDate As System.Web.UI.WebControls.TextBox
    Protected WithEvents lblEffectiveDateLink As System.Web.UI.WebControls.Label
    Protected WithEvents txtExpirationDate As System.Web.UI.WebControls.TextBox
    Protected WithEvents lblExpirationDateLink As System.Web.UI.WebControls.Label
    ...
    Protected WithEvents plExpirationDate As System.Web.UI.WebControls.PlaceHolder
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Catch ex As Exception
            Throw New Exception("Error #702: BulkAppointment Page_Load. " & ex.Message)
        End Try
    End Sub
    ...
    Private Function ExecuteRequestAction(ByVal PageMode As PageMode, ByVal RequestAction As LocalRequestAction) As Results
        ...
        Try
            ...
            Select Case RequestAction
                ...
                Case RequestAction.SaveNewOrExisting
                    'ValidationResults = IsDataValid(RequestAction)
                    'If ValidationResults.Success Then
                    SaveResults = PerformSave(RequestAction)
                    If SaveResults.Success Then
    ...
    Private Function IsDataValid(ByVal RequestAction As LocalRequestAction) As Results
        Dim MyResults As New Results
    ...
    Private Function PerformSave(ByVal RequestAction As LocalRequestAction) As Results
        Dim i, j As Integer
        Dim SaveResults As New Results
        Dim ErrColl As New Collection
        ...
        Try
            ...
            If IsDate(txtEffectiveDate.Text) Then
                For i = 0 To cBulkAppointmentDataPack.DT.Rows.Count - 1
                    If cBulkAppointmentDataPack.DT.Rows(i)("SaveType") = cBulkAppointmentDataPack.SaveTypeClass.ApptExpressJITTrigger Then
    ...
    Private Sub PerformSave2(ByRef LicRules As LicRules, ByRef SaveResults As Results, ByVal State As String, ByVal CarrierID As String)
        Dim i As Integer
    ...
    Private Sub PerformSave3(ByRef SaveResults As Results, ByVal State As String, ByVal CarrierID As String, ByRef OrphanTestArgs As LicRules.OrphanTestArgs)
