...
#Region " Declarations "
    ...
    Protected WithEvents ddState As System.Web.UI.WebControls.DropDownList
    ...
    Protected WithEvents ddOKToRenewInd As System.Web.UI.WebControls.DropDownList
    Protected WithEvents txtOKToRenewInd As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            cAdminLicRight = cRights.HasThisRight(cRights.AdminLicSpecific)
    ...
    Private Function PerformSave(ByVal RequestAction As RequestAction) As Results
        ...
        Try
            ...
            Try
                ...
                If RequestAction = RequestAction.SaveNew AndAlso IsDate(txtEffectiveDate.Text) Then
    ...
    Private Sub DisplayPage(ByVal ResponseAction As ResponseAction)
        ...
        Try
            ...
            Select Case ResponseAction
                ...
                Case ResponseAction.DisplayUserInputExisting
    ...
    Private Sub FormatControls(ByVal ResponseAction As ResponseAction)
        Try
