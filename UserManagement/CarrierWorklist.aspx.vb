...
#End Region
    ...
    Private Function DefineDataGrid() As DG
        Try
            ...
            DG.AddNewButton(cRights.CarrierEdit)
            ...
            TemplateCol.AddDefaultTemplateItem("View", "ExistingRecord", "StandardView", "User record", cRights.CarrierView, Nothing)
            TemplateCol.AddDefaultTemplateItem("Delete", "Delete", "StandardDelete", "Delete", cRights.CarrierView, Nothing)
