...
/*
	var obj_calwindow = window.open(
		'calendar.aspx?id=' + this.id + '&s=' + this.dt_selected.valueOf() + '&c=' + this.dt_current.valueOf(),
...
*/	
	...
	var obj_calwindow = window.open(
		'calendar.aspx?targetctl=' + this.target.name + '&id=' + this.id + '&s=' + this.dt_selected.valueOf() + '&c=' + this.dt_current.valueOf(),
		'Calendar', 'width=200,height=' + (this.time_comp ? 230 : 205) +
		',status=no,resizable=no,top=200,left=200,dependent=yes,alwaysRaised=yes'
	);
