...
#Region " Constants "
    Public Const UserView = "USV"
    Public Const UserEdit = "USE"
    Public Const PermissionsView = "PRV"
    Public Const PermissionsEdit = "PRE"
    Public Const LicenseView = "LIV"
    Public Const LicenseEdit = "LIE"
    Public Const CarrierView = "CAV"
    Public Const CarrierEdit = "CAE"
    Public Const ClientView = "CLV"
    Public Const ClientEdit = "CLE"
    Public Const CompanyView = "COV"
    Public Const CompanyEdit = "COE"
    Public Const AdminLicSpecific = "ALS"
#End Region
