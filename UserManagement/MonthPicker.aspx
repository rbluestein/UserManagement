<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MonthPicker.aspx.vb" Inherits="UserManagement.MonthPicker" %>
	...
	<body onunload="fnClose()">
		<form id="form1" method="post" runat="server">
			...
			<table cellpadding="2" cellspacing="0" style="LEFT: 10px; POSITION: absolute; TOP: 60px">
				<tr>
					<td><input type="text" id="txtFromMonthYear" name="txtFromMonthYear" readonly></td>
				</tr>
			</table>
			...
			<table cellpadding="0" style="LEFT: 10px; POSITION: absolute; TOP: 180px">
				<tr>
					<td><input type="text" id="txtToMonthYear" name="txtToMonthYear" readonly></td>
				</tr>
			</table>
