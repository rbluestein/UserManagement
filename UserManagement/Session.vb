...
'Public Class OldAppSession    KEEP THIS FOR NOW
'    Private cActiveSqlServerConnString As String
'    Private cRightsStr As String
'    Private cLoggedInUserID As String
'    Private cBVITestSqlServerConnString As String
'    Private cBVIProdSqlServerConnString As String
'    Private cDellSqlServerConnString As String

'    Public ReadOnly Property LoggedInUserID()
'        Get
...
'    Public Function SqlServerConnectionString(ByVal SqlServer As String, ByVal DB As String) As String
'        Select Case SqlServer
'            Case "Dell"
'                Return Replace(cDellSqlServerConnString, "|", DB)
'            Case "Test"
'                Return Replace(cBVITestSqlServerConnString, "|", DB)
'            Case "Prod"
'                Return Replace(cBVIProdSqlServerConnString, "|", DB)
'        End Select
'    End Function

'    Public Function GetEnvironment() As String
'        Dim configurationAppSettings As System.Configuration.AppSettingsReader = New System.Configuration.AppSettingsReader
'        Select Case CType(configurationAppSettings.GetValue("ActiveSqlServer", GetType(System.String)), String)
'            Case "BVITest"
'                Return "Test"
'            Case "BVIProd"
'                Return "Prod"
...
'    Public Function ConnectionString(Optional ByVal db As String = "UserManagement") As String
'        Dim ActiveConnString As String
'        If db = "UserManagement" Then
'            Return Replace(cActiveSqlServerConnString, "|", "UserManagement")
'        Else
...
'        cBVITestSqlServerConnString = CType(configurationAppSettings.GetValue("BVITestSqlServerConnString", GetType(System.String)), String)
'        cBVIProdSqlServerConnString = CType(configurationAppSettings.GetValue("BVIProdSqlServerConnString", GetType(System.String)), String)
'        cDellSqlServerConnString = CType(configurationAppSettings.GetValue("DellSqlServerConnString", GetType(System.String)), String)
...
'        If System.Environment.MachineName.ToUpper = "LT-5ZFYRC1" Then
'            cLoggedInUserID = "ricksupv"
'            cLoggedInUserID = "rgreen"
'            'cLoggedInUserID = "enroller"
'            'cLoggedInUserID = "aapostrophe"  ' admin
'            cLoggedInUserID = "rbluestein"
'        Else
'            cLoggedInUserID = HttpContext.Current.User.Identity.Name.ToString
'            cLoggedInUserID = cLoggedInUserID.Substring(InStr(cLoggedInUserID, "\", CompareMethod.Binary))
'        End If

'        Dim SessionCookie As HttpCookie
'        SessionCookie = New HttpCookie("BVIULM", cLoggedInUserID)
...
'        Try
'            If IsNothing(Page.Request.Cookies.Item("BVIULM")) Then
'                Throw New Exception("No Cookie Present.")
'            Else
'                LoggedInUserID = Page.Request.Cookies.Item("BVIULM").Value
'            End If
