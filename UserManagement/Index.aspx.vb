...
#End Region
    ...
    '        Sql = "exec usp_GetLTCCert @EnrollerID = 'jwatroba', @State = 'MD'"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Catch ex As Exception
            Throw New Exception("Error #102: Index Page_Load. " & ex.Message)
        End Try
    End Sub

    'Private Sub UpdateTimeSensitiveData()
    ...
    '        Querypack = cCommon.ExecuteNonQueryWithQuerypack(sb.ToString)
    '        If Not Querypack.Success Then
    '            Throw New Exception("Error #114a: Index UpdateTimeSensitiveData. " & Querypack.TechErrMsg)
    '        End If

    '    Catch ex As Exception
    '        Throw New Exception("Error #114b: Index UpdateTimeSensitiveData. " & ex.Message)
    '    End Try
    'End Sub
    ...
    Private Sub AdHoc()
        ...
        Dim UserAppointments As DataTable
        Dim i As Integer
        Dim Querypack As DBase.QueryPack
    ...
    Private Sub LoadEnviro()
        ...
        Catch ex As Exception
            Throw New Exception("Error #103: Index SetEnviro. " & ex.Message)
        End Try
    End Sub
    ...
    Private Function DefineDataGrid() As DG
        Try
            ...
            TemplateCol.AddDefaultTemplateItem("View", "ExistingRecord", "StandardView", "User record", cRights.UserView, Nothing)
            TemplateCol.AddDefaultTemplateItem("Permissions", "Permissions", "StandardClip", "Permissions", cRights.PermissionsView, Nothing)
            TemplateCol.AddDefaultTemplateItem("License", "License", "StandardNotes", "Licenses", cRights.LicenseView, "IsSupvOrEnroller", Nothing)
            TemplateCol.AddDefaultTemplateItem("Delete", "Delete", "StandardDelete", "Delete", cRights.UserEdit, Nothing, "FirstLastName")
