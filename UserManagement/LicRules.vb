Public Class LicRules
    ...
    Public Sub Lic_KeyViolationCheck(ByRef RequestAction As RequestAction, ByRef ErrColl As Collection, ByVal UserID As String, ByVal State As String)
        Dim dt As DataTable
    ...
    Public Sub Appt_AllowThisEdit(ByRef RequestAction As RequestAction, ByRef ErrColl As Collection, ByVal UserID As String, ByVal State As String, ByVal EffectiveDate As String, ByVal ExpirationDate As String, ByVal StatusCode As String)
    ...
    Public Sub Appt_TestOneCarrierPerState(ByVal RequestAction As RequestAction, ByRef ErrColl As Collection, ByVal Sess As LicenseWorklistSession, ByVal CarrierID As String)
        Dim dt As DataTable
